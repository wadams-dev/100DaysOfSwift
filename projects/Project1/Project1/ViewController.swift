...
//  Project1
//
//  Created by William Adams on 8/30/22.
//
...
class ViewController: UITableViewController {
    ...
    @objc func recommend() {
        let vc = UIActivityViewController(activityItems: ["Check out the Storm Viewer app on the App Store!"], applicationActivities: [])
